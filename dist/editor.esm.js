...
var Copy = function Copy(_ref) {
  ...
  return React.createElement('div', null, React.createElement(CodeContainer, null, React.createElement(lib_1, {
    text: value,
    onCopy: resolvedOnCopy || undefined
  }, React.createElement(Column, null, React.createElement(Button, { height: '24px', type: 'button' }, React.createElement(EmojiContainer, null, React.createElement('span', { role: 'img', 'aria-label': 'Copy', title: 'Copy' }, '\uD83D\uDCCB'))))), React.createElement('pre', null, React.createElement('code', null, value))));
};
...
var Editor = function (_React$Component) {
  ...
  _createClass(Editor, [{
    ...
    value: function render() {
      ...
      return React.createElement('div', null, React.createElement(Row, null, React.createElement(Container, { margin: '0px 32px' }, React.createElement(TextInput, {
        textArea: true,
        onChange: this.onTextChange,
        value: rawMarkdown,
        placeholder: placeholder
      })), React.createElement(Container, { margin: '0px 32px 0px 0px' }, React.createElement(Card, { style: { flex: 1 } }, React.createElement(CardPrimary, null, React.createElement('h2', null, 'Markdown Preview')), React.createElement(CardSecondary, null, React.createElement('div', { className: 'markdown-body' }, rawMarkdown ? mdParser(rawMarkdown) : null))))), React.createElement(Container, { margin: '32px' }, React.createElement(Card, null, editing ? React.createElement(TextInput, {
        textArea: true,
        ...
        value: value,
        singleLine: false
      }), React.createElement(CardActions, null, React.createElement(Button, { type: 'button', onClick: function onClick() {
