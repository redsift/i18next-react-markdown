(function (global, factory) {
	...
	(factory((global.MarkdownEditor = {}),global.React,global.marksy));
}(this, (function (exports,React,marksy) { 'use strict';

var React__default = 'default' in React ? React['default'] : React;
marksy = marksy && marksy.hasOwnProperty('default') ? marksy['default'] : marksy;
...
var _for$2 = createCommonjsModule(function (module) {
module.exports = { "default": _for, __esModule: true };
});
var _Symbol$for = unwrapExports(_for$2);
...
var _Symbol3 = unwrapExports(symbol$2);
...
var ownKeys$2 = createCommonjsModule(function (module) {
module.exports = { "default": ownKeys, __esModule: true };
});
var _Reflect$ownKeys = unwrapExports(ownKeys$2);
...
var _Object$getPrototypeOf2 = unwrapExports(getPrototypeOf$2);
...
var _JSON$stringify2 = unwrapExports(stringify$2);
...
var $JSON$2 = _core$2.JSON || (_core$2.JSON = { stringify: _JSON$stringify2 });
var stringify$3 = function stringify(it) {
  return $JSON$2.stringify.apply($JSON$2, arguments);
};
var stringify$2$1 = createCommonjsModule$1(function (module) {
  module.exports = { "default": stringify$3, __esModule: true };
});
var _JSON$stringify = unwrapExports$1(stringify$2$1);
var _defined$2 = function _defined(it) {
  if (it == undefined) throw TypeError("Can't call method on  " + it);
  return it;
};
var _toObject$2 = function _toObject(it) {
...
var _library$2 = true;
var _shared$2 = createCommonjsModule$1(function (module) {
  var SHARED = '__core-js_shared__';
...
var _ie8DomDefine$2 = !_descriptors$2 && !_fails$2(function () {
  return Object.defineProperty(_domCreate$2('div'), 'a', { get: function get() {
      return 7;
    } }).a != 7;
});
...
var dP$2 = _Object$defineProperty;
var f$7 = _descriptors$2 ? _Object$defineProperty : function defineProperty(O, P, Attributes) {
  _anObject$2(O);
...
var $export$2 = function $export(type, name, source) {
  ...
  for (key in source) {
    ...
    out = own ? target[key] : source[key];
    exports[key] = IS_GLOBAL && typeof target[key] != 'function' ? source[key] : IS_BIND && own ? _ctx$2(out, _global$2) : IS_WRAP && target[key] == out ? function (C) {
    ...
    if (IS_PROTO) {
      (exports.virtual || (exports.virtual = {}))[key] = out;
      if (type & $export.R && expProto && !expProto[key]) _hide$2(expProto, key, out);
    }
  }
};
$export$2.F = 1;
...
var _objectSap$2 = function _objectSap(KEY, exec) {
...
var getPrototypeOf$1$1 = _core$2.Object.getPrototypeOf;
var getPrototypeOf$3 = createCommonjsModule$1(function (module) {
  module.exports = { "default": getPrototypeOf$1$1, __esModule: true };
});
var _Object$getPrototypeOf = unwrapExports$1(getPrototypeOf$3);
...
var _toInteger$2 = function _toInteger(it) {
  return isNaN(it = +it) ? 0 : (it > 0 ? floor$1 : ceil$1)(it);
};
var _stringAt$2 = function _stringAt(TO_STRING) {
  return function (that, pos) {
...
var _objectKeysInternal$2 = function _objectKeysInternal(object, names) {
  var O = _toIobject$2(object);
  var i = 0;
  var result = [];
  var key;
  for (key in O) {
    if (key != IE_PROTO$1$1) _has$2(O, key) && result.push(key);
  }while (names.length > i) {
    if (_has$2(O, key = names[i++])) {
...
var _objectKeys$2 = _Object$keys || function keys(O) {
  return _objectKeysInternal$2(O, _enumBugKeys$2);
};
var _objectDps$2 = _descriptors$2 ? _Object$defineProperties : function defineProperties(O, Properties) {
  _anObject$2(O);
  ...
  var P;
  while (length > i) {
    _objectDp$2.f(O, P = keys[i++], Properties[P]);
  }return O;
};
...
var _createDict = function createDict() {
  ...
  while (i--) {
    delete _createDict[PROTOTYPE$1$1][_enumBugKeys$2[i]];
  }return _createDict();
};
var _objectCreate$2 = _Object$create || function create(O, Properties) {
  var result;
  if (O !== null) {
...
var _wks$2 = createCommonjsModule$1(function (module) {
  ...
  var _Symbol = _global$2.Symbol;
  var USE_SYMBOL = typeof _Symbol == 'function';
  var $exports = module.exports = function (name) {
    return store[name] || (store[name] = USE_SYMBOL && _Symbol[name] || (USE_SYMBOL ? _Symbol : _uid$2)('Symbol.' + name));
  };
  $exports.store = store;
});
var def$1 = _objectDp$2.f;
var TAG$1 = _wks$2('toStringTag');
var _setToStringTag$2 = function _setToStringTag(it, tag, stat) {
...
var _iterCreate$2 = function _iterCreate(Constructor, NAME, next) {
...
var _iterDefine$2 = function _iterDefine(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCED) {
  ...
  if ($anyNative) {
    ...
    if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
      ...
      if (!_library$2 && typeof IteratorPrototype[ITERATOR$1] != 'function') _hide$2(IteratorPrototype, ITERATOR$1, returnThis$1);
    }
  }
...
var _iterStep$2 = function _iterStep(done, value) {
  return { value: value, done: !!done };
};
...
var iterator$3 = _wksExt$2.f('iterator');
var iterator$2$1 = createCommonjsModule$1(function (module) {
  module.exports = { "default": iterator$3, __esModule: true };
});
unwrapExports$1(iterator$2$1);
var _meta$2 = createCommonjsModule$1(function (module) {
  ...
  var fastKey = function fastKey(it, create) {
    if (!_isObject$2(it)) return (typeof it === 'undefined' ? 'undefined' : _typeof2(it)) == 'symbol' ? it : (typeof it == 'string' ? 'S' : 'P') + it;
    if (!_has$2(it, META)) {
      if (!isExtensible(it)) return 'F';
      if (!create) return 'E';
      setMeta(it);
...
var _wksDefine$2 = function _wksDefine(name) {
  var $Symbol = _core$2.Symbol || (_core$2.Symbol = _library$2 ? {} : _global$2.Symbol || {});
  if (name.charAt(0) != '_' && !(name in $Symbol)) defineProperty$4$1($Symbol, name, { value: _wksExt$2.f(name) });
};
var f$2$1 = _Object$getOwnPropertySymbols;
var _objectGops$2 = {
  f: f$2$1
};
...
var _enumKeys$2 = function _enumKeys(it) {
...
var f$4$1 = _Object$getOwnPropertyNames || function getOwnPropertyNames(O) {
...
var windowNames$1 = (typeof window === 'undefined' ? 'undefined' : _typeof2(window)) == 'object' && window && _Object$getOwnPropertyNames ? _Object$getOwnPropertyNames(window) : [];
...
var f$5$1 = function getOwnPropertyNames(it) {
  return windowNames$1 && toString$1$1.call(it) == '[object Window]' ? getWindowNames$1(it) : gOPN$3(_toIobject$2(it));
};
var _objectGopnExt$2 = {
  f: f$5$1
};
var gOPD$2 = _Object$getOwnPropertyDescriptor;
var f$6$1 = _descriptors$2 ? gOPD$2 : function getOwnPropertyDescriptor(O, P) {
  O = _toIobject$2(O);
  P = _toPrimitive$2(P, true);
  if (_ie8DomDefine$2) try {
    return gOPD$2(O, P);
...
var gOPD$1$1 = _objectGopd$2.f;
var dP$1$1 = _objectDp$2.f;
var gOPN$1$1 = _objectGopnExt$2.f;
var $Symbol$1 = _global$2.Symbol;
var $JSON$1$1 = _global$2.JSON;
...
var setSymbolDesc$1 = _descriptors$2 && _fails$2(function () {
  return _objectCreate$2(dP$1$1({}, 'a', {
    get: function get() {
      return dP$1$1(this, 'a', { value: 7 }).a;
    }
  })).a != 7;
}) ? function (it, key, D) {
...
var wrap$1 = function wrap(tag) {
  var sym = AllSymbols$1[tag] = _objectCreate$2($Symbol$1[PROTOTYPE$2$1]);
  sym._k = tag;
  return sym;
};
var isSymbol$1 = USE_NATIVE$1 && _typeof2($Symbol$1.iterator) == 'symbol' ? function (it) {
...
var $defineProperty$1 = function defineProperty(it, key, D) {
  ...
  if (_has$2(AllSymbols$1, key)) {
    if (!D.enumerable) {
      if (!_has$2(it, HIDDEN$1)) dP$1$1(it, HIDDEN$1, _propertyDesc$2(1, {}));
...
var $getOwnPropertyNames$1 = function getOwnPropertyNames(it) {
  var names = gOPN$1$1(_toIobject$2(it));
  var result = [];
  var i = 0;
  var key;
  while (names.length > i) {
...
var $getOwnPropertySymbols$1 = function getOwnPropertySymbols(it) {
  ...
  var names = gOPN$1$1(IS_OP ? OPSymbols$1 : _toIobject$2(it));
  var result = [];
  var i = 0;
  var key;
  while (names.length > i) {
...
if (!USE_NATIVE$1) {
  $Symbol$1 = function _Symbol2() {
    ...
    if (_descriptors$2 && setter$1) setSymbolDesc$1(ObjectProto$1$1, tag, { configurable: true, set: $set });
    return wrap$1(tag);
  };
  _redefine$2($Symbol$1[PROTOTYPE$2$1], 'toString', function toString() {
    return this._k;
  });
...
for (var es6Symbols$1 = 'hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables'.split(','), j$1 = 0; es6Symbols$1.length > j$1;) {
  _wks$2(es6Symbols$1[j$1++]);
}for (var wellKnownSymbols$1 = _objectKeys$2(_wks$2.store), k$1 = 0; wellKnownSymbols$1.length > k$1;) {
  _wksDefine$2(wellKnownSymbols$1[k$1++]);
}_export$2(_export$2.S + _export$2.F * !USE_NATIVE$1, 'Symbol', {
  'for': function _for(key) {
    return _has$2(SymbolRegistry$1, key += '') ? SymbolRegistry$1[key] : SymbolRegistry$1[key] = $Symbol$1(key);
  },
  keyFor: function keyFor(sym) {
...
$JSON$1$1 && _export$2(_export$2.S + _export$2.F * (!USE_NATIVE$1 || _fails$2(function () {
  var S = $Symbol$1();
  ...
  stringify: function stringify(it) {
    ...
    if (!_isObject$2(replacer) && it === undefined || isSymbol$1(it)) return;
    if (!_isArray$2(replacer)) replacer = function replacer(key, value) {
      if (typeof $replacer == 'function') value = $replacer.call(this, key, value);
...
$Symbol$1[PROTOTYPE$2$1][TO_PRIMITIVE$1] || _hide$2($Symbol$1[PROTOTYPE$2$1], TO_PRIMITIVE$1, $Symbol$1[PROTOTYPE$2$1].valueOf);
...
var symbol$3 = _core$2.Symbol;
var symbol$2$1 = createCommonjsModule$1(function (module) {
  module.exports = { "default": symbol$3, __esModule: true };
});
unwrapExports$1(symbol$2$1);
var _typeof_1$1 = createCommonjsModule$1(function (module, exports) {
  exports.__esModule = true;
  var _iterator2 = _interopRequireDefault(iterator$2$1);
  var _symbol2 = _interopRequireDefault(symbol$2$1);
...
var _setProto$2 = {
  set: _Object$setPrototypeOf || ('__proto__' in {} ? function (test, buggy, set) {
    try {
...
_export$2(_export$2.S, 'Object', { setPrototypeOf: _setProto$2.set });
var setPrototypeOf$3 = _core$2.Object.setPrototypeOf;
var setPrototypeOf$2$1 = createCommonjsModule$1(function (module) {
  module.exports = { "default": setPrototypeOf$3, __esModule: true };
});
unwrapExports$1(setPrototypeOf$2$1);
_export$2(_export$2.S, 'Object', { create: _objectCreate$2 });
var $Object$1$1 = _core$2.Object;
var create$3 = function create(P, D) {
  return $Object$1$1.create(P, D);
};
var create$2$1 = createCommonjsModule$1(function (module) {
  module.exports = { "default": create$3, __esModule: true };
});
unwrapExports$1(create$2$1);
var inherits = createCommonjsModule$1(function (module, exports) {
  exports.__esModule = true;
  var _setPrototypeOf2 = _interopRequireDefault(setPrototypeOf$2$1);
  var _create2 = _interopRequireDefault(create$2$1);
  var _typeof3 = _interopRequireDefault(_typeof_1$1);
  function _interopRequireDefault(obj) {
    return obj && obj.__esModule ? obj : { default: obj };
  }
...
var $Object$2$1 = _core$2.Object;
var defineProperties$3 = function defineProperties(T, D) {
  return $Object$2$1.defineProperties(T, D);
};
var defineProperties$2$1 = createCommonjsModule$1(function (module) {
  module.exports = { "default": defineProperties$3, __esModule: true };
});
unwrapExports$1(defineProperties$2$1);
var meta$1 = _meta$2.onFreeze;
_objectSap$2('freeze', function ($freeze) {
  return function freeze(it) {
    return $freeze && _isObject$2(it) ? $freeze(meta$1(it)) : it;
  };
});
var freeze = _core$2.Object.freeze;
var freeze$2 = createCommonjsModule$1(function (module) {
  module.exports = { "default": freeze, __esModule: true };
});
unwrapExports$1(freeze$2);
var taggedTemplateLiteral = createCommonjsModule$1(function (module, exports) {
  exports.__esModule = true;
  var _defineProperties2 = _interopRequireDefault(defineProperties$2$1);
...
var _taggedTemplateLiteral = unwrapExports$1(taggedTemplateLiteral);
...
EventHandlers.prototype = _Object$create(null);
...
EventEmitter.init = function () {
  ...
  if (!this._events || this._events === _Object$getPrototypeOf2(this)._events) {
...
EventEmitter.prototype.eventNames = function eventNames() {
  return this._eventsCount > 0 ? _Reflect$ownKeys(this._events) : [];
};
...
function format(f) {
  ...
  var str = String(f).replace(formatRegExp, function (x) {
    ...
    switch (x) {
      ...
      case '%j':
        try {
          return _JSON$stringify2(args[i++]);
        } catch (_) {
          return '[Circular]';
        }
      default:
...
function formatPrimitive(ctx, value) {
  ...
  if (isString(value)) {
    var simple = '\'' + _JSON$stringify2(value).replace(/^"|"$/g, '').replace(/'/g, "\\'").replace(/\\"/g, '"') + '\'';
...
function formatArray(ctx, value, recurseTimes, visibleKeys, keys) {
  ...
  for (var i = 0, l = value.length; i < l; ++i) {
    if (hasOwnProperty$1$1(value, String(i))) {
...
function formatProperty(ctx, value, recurseTimes, visibleKeys, key, array) {
  ...
  if (!hasOwnProperty$1$1(visibleKeys, key)) {
    name = '[' + key + ']';
  }
  if (!str) {
...
function hasOwnProperty$1$1(obj, prop) {
...
var isArray$2 = Array.isArray || function (arr) {
  return toString$2$1.call(arr) == '[object Array]';
};
/*!
...
function bidirectionalIndexOf(buffer, val, byteOffset, encoding, dir) {
  ...
  if (internalIsBuffer(val)) {
    ...
    return arrayIndexOf$1$1(buffer, val, byteOffset, encoding, dir);
...
function arrayIndexOf$1$1(arr, val, byteOffset, encoding, dir) {
  var indexSize = 1;
...
var keys$3 = _Object$keys(Writable$1.prototype);
...
@license MIT
*/
var getOwnPropertySymbols$3 = _Object$getOwnPropertySymbols;
...
function shouldUseNative() {
  try {
    ...
    var order2 = _Object$getOwnPropertyNames(test2).map(function (n) {
      return test2[n];
    });
...
var factoryWithTypeCheckers = function factoryWithTypeCheckers(isValidElement, throwOnDirectAccess) {
  var ITERATOR_SYMBOL = typeof _Symbol3 === 'function' && _Symbol$iterator;
  ...
  function createEnumTypeChecker(expectedValues) {
    ...
    function validate(props, propName, componentName, location, propFullName) {
      ...
      var valuesString = _JSON$stringify2(expectedValues);
  ...
  function createStrictShapeTypeChecker(shapeTypes) {
    function validate(props, propName, componentName, location, propFullName) {
      ...
      for (var key in allKeys) {
        var checker = shapeTypes[key];
        if (!checker) {
          return new PropTypeError('Invalid ' + location + ' `' + propFullName + '` key `' + key + '` supplied to `' + componentName + '`.' + '\nBad object: ' + _JSON$stringify2(props[propName], null, '  ') + '\nValid keys: ' + _JSON$stringify2(_Object$keys(shapeTypes), null, '  '));
        }
        var error = checker(propValue, key, componentName, location, propFullName + '.' + key, ReactPropTypesSecret_1);
        if (error) {
          return error;
  ...
  function isSymbol(propType, propValue) {
    ...
    if (typeof _Symbol3 === 'function' && propValue instanceof _Symbol3) {
      return true;
    }
    return false;
  }
...
var propTypes = createCommonjsModule$1(function (module) {
  if (process.env.NODE_ENV !== 'production') {
    var REACT_ELEMENT_TYPE = typeof _Symbol3 === 'function' && _Symbol$for && _Symbol$for('react.element') || 0xeac7;
...
var getOwnPropertyNames$3 = _Object$getOwnPropertyNames;
var getOwnPropertySymbols$1$1 = _Object$getOwnPropertySymbols;
var getOwnPropertyDescriptor$3 = _Object$getOwnPropertyDescriptor;
var getPrototypeOf$4 = _Object$getPrototypeOf2;
...
function hoistNonReactStatics(targetComponent, sourceComponent, blacklist) {
  if (typeof sourceComponent !== 'string') {
    ...
    if (getOwnPropertySymbols$1$1) {
      keys = keys.concat(getOwnPropertySymbols$1$1(sourceComponent));
    }
...
var reactIs_production_min = createCommonjsModule$1(function (module, exports) {
   ...
   */
  Object.defineProperty(exports, "__esModule", { value: !0 });var b = "function" === typeof _Symbol3 && _Symbol$for,
      ...
      m = b ? _Symbol$for("react.forward_ref") : 60112,
      n = b ? _Symbol$for("react.timeout") : 60113;
  function q(a) {
  ...
  exports.isValidElementType = function (a) {
    return "string" === typeof a || "function" === typeof a || a === e || a === l || a === g || a === f || a === n || "object" === (typeof a === 'undefined' ? 'undefined' : _typeof2(a)) && null !== a && (a.$$typeof === h || a.$$typeof === k || a.$$typeof === m);
...
var reactIs_development = createCommonjsModule$1(function (module, exports) {
  ...
  if (process.env.NODE_ENV !== "production") {
    (function () {
      ...
      var hasSymbol = typeof _Symbol3 === 'function' && _Symbol$for;
      ...
      var REACT_CONTEXT_TYPE = hasSymbol ? _Symbol$for('react.context') : 0xeace;
      ...
      var REACT_TIMEOUT_TYPE = hasSymbol ? _Symbol$for('react.timeout') : 0xead1;
      function isValidElementType(type) {
        return typeof type === 'string' || typeof type === 'function' || type === REACT_FRAGMENT_TYPE || type === REACT_ASYNC_MODE_TYPE || type === REACT_PROFILER_TYPE || type === REACT_STRICT_MODE_TYPE || type === REACT_TIMEOUT_TYPE || (typeof type === 'undefined' ? 'undefined' : _typeof2(type)) === 'object' && type !== null && (type.$$typeof === REACT_PROVIDER_TYPE || type.$$typeof === REACT_CONTEXT_TYPE || type.$$typeof === REACT_FORWARD_REF_TYPE);
      }
...
var _typeof$1 = typeof _Symbol3 === "function" && _typeof2(_Symbol$iterator) === "symbol" ? function (obj) {
  return typeof obj === 'undefined' ? 'undefined' : _typeof2(obj);
} : function (obj) {
  return obj && typeof _Symbol3 === "function" && obj.constructor === _Symbol3 && obj !== _Symbol3.prototype ? "symbol" : typeof obj === 'undefined' ? 'undefined' : _typeof2(obj);
};
...
var inherits$3 = function inherits$3(subClass, superClass) {
  if (typeof superClass !== "function" && superClass !== null) {
...
var addNameForId = function addNameForId(names, id, name) {
  if (name) {
    var namesForId = names[id] || (names[id] = _Object$create(null));
    namesForId[name] = true;
  }
};
var resetIdNames = function resetIdNames(names, id) {
  names[id] = _Object$create(null);
};
...
var stringifyNames = function stringifyNames(names) {
  var str = '';
  for (var id in names) {
    str += _Object$keys(names[id]).join(' ') + ' ';
  }
  return str.trim();
};
var cloneNames = function cloneNames(names) {
  var clone = _Object$create(null);
  for (var id in names) {
...
var getIdsFromMarkersFactory = function getIdsFromMarkersFactory(markers) {
  return function () {
    return _Object$keys(markers);
  };
};
var makeSpeedyTag = function makeSpeedyTag(el, getImportRuleTag) {
  var names = _Object$create(null);
  var markers = _Object$create(null);
  var sizes = [];
...
var makeServerTagInternal = function makeServerTagInternal(namesArg, markersArg) {
  var names = namesArg === undefined ? _Object$create(null) : namesArg;
  var markers = markersArg === undefined ? _Object$create(null) : markersArg;
  var insertMarker = function insertMarker(id) {
    var prev = markers[id];
    if (prev !== undefined) {
      return prev;
  ...
  var clone = function clone() {
    ...
    var markersClone = _Object$create(null);
    for (var id in markers) {
...
var createWarnTooManyClasses = function createWarnTooManyClasses(displayName) {
  ...
  return function (className) {
    if (!warningSeen) {
      ...
      if (_Object$keys(generatedClasses).length >= LIMIT) {
...
function hasInInheritanceChain(child, parent) {
  var target = child;
  while (target) {
    target = _Object$getPrototypeOf2(target);
...
var _StyledComponent = function _StyledComponent(ComponentStyle, constructWithOptions) {
  ...
  var BaseStyledComponent = function (_Component) {
    ...
    BaseStyledComponent.prototype.buildExecutionContext = function buildExecutionContext(theme, props) {
      ...
      this.attrs = _Object$keys(attrs).reduce(function (acc, key) {
        var attr = attrs[key];
    ...
    BaseStyledComponent.prototype.render = function render() {
      ...
      var propsForElement = _Object$keys(this.props).reduce(function (acc, propName) {
...
var _objectAssign$2 = !$assign$1 || _fails$2(function () {
  ...
  return $assign$1({}, A)[S] != 7 || _Object$keys($assign$1({}, B)).join('') != K;
}) ? function assign(target, source) {
...
var _extends$2 = unwrapExports$1(_extends$1);
var createParser = function createParser(elements, components, marksyOptions) {
  ...
  var createElement$$1 = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : React.createElement;
...
var Component$1 = createCommonjsModule$1(function (module, exports) {
  ...
  var CopyToClipboard = exports.CopyToClipboard = function (_React$PureComponent) {
    ...
    function CopyToClipboard() {
      ...
      return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CopyToClipboard.__proto__ || _Object$getPrototypeOf2(CopyToClipboard)).call.apply(_ref, [this].concat(args))), _this), _this.onClick = function (event) {
...
var Copy = function Copy(_ref) {
  ...
  return React__default.createElement('div', null, React__default.createElement(CodeContainer, null, React__default.createElement(lib_1, {
    text: value,
    onCopy: resolvedOnCopy || undefined
  }, React__default.createElement(Column, null, React__default.createElement(Button, { height: '24px', type: 'button' }, React__default.createElement(EmojiContainer, null, React__default.createElement('span', { role: 'img', 'aria-label': 'Copy', title: 'Copy' }, '\uD83D\uDCCB'))))), React__default.createElement('pre', null, React__default.createElement('code', null, value))));
};
...
var Editor = function (_React$Component) {
  ...
  _createClass(Editor, [{
    ...
    value: function render() {
      ...
      return React__default.createElement('div', null, React__default.createElement(Row, null, React__default.createElement(Container, { margin: '0px 32px' }, React__default.createElement(TextInput, {
        textArea: true,
        onChange: this.onTextChange,
        value: rawMarkdown,
        placeholder: placeholder
      })), React__default.createElement(Container, { margin: '0px 32px 0px 0px' }, React__default.createElement(Card, { style: { flex: 1 } }, React__default.createElement(CardPrimary, null, React__default.createElement('h2', null, 'Markdown Preview')), React__default.createElement(CardSecondary, null, React__default.createElement('div', { className: 'markdown-body' }, rawMarkdown ? mdParser(rawMarkdown) : null))))), React__default.createElement(Container, { margin: '32px' }, React__default.createElement(Card, null, editing ? React__default.createElement(TextInput, {
        textArea: true,
        ...
        value: value,
        singleLine: false
      }), React__default.createElement(CardActions, null, React__default.createElement(Button, { type: 'button', onClick: function onClick() {
